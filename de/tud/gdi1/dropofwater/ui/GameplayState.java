...
public class GameplayState extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	background.addComponent(new ImageRenderComponent(new Image("/assets/trees.png"))); // Bildkomponente
    	...
    	mouse_Clicked.addAction(new Action() {
			...
			public void update(GameContainer gc, StateBasedGame sb, int delta,
				...
				Entity herz = new Entity("drop of water");
				Entity drop = new Entity("drop of water");
				herz.setPosition(new Vector2f(gc.getInput().getMouseX(),gc.getInput().getMouseY()));
				drop.setPosition(new Vector2f(150,180));
				try {
					// Bild laden und zuweisen
					herz.addComponent(new ImageRenderComponent(new Image("assets/herz.png")));
					
				} catch (SlickException e) {
					System.err.println("Cannot find file assets/herz.png!");
					e.printStackTrace();
				}
				try {
					// Bild laden und zuweisen
				...
				LoopEvent loop2 = new LoopEvent();
		    	loop.addAction(new RotateRightAction(0.5f));
		    	loop2.addAction(new MoveRightAction(0.5f));
		    	herz.addComponent(loop);
		    	drop.addComponent(loop2);
		    	...
		    	entityManager.addEntity(stateID, herz);
			}    		
    	});
