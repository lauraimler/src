...
public class MainMenuState extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	new_Game_Entity.setPosition(new Vector2f(95, 190));
    	new_Game_Entity.setScale(0.28f);
    	new_Game_Entity.addComponent(new ImageRenderComponent(new Image("assets/herz.png")));
    	...
    	// Setze Position und Bildkomponente
    	quit_Entity.setPosition(new Vector2f(95, 290));
    	quit_Entity.setScale(0.28f);
    	quit_Entity.addComponent(new ImageRenderComponent(new Image("assets/herz.png")));
	...
	public void render(GameContainer container, StateBasedGame game, 
		...
		int counter = 0;
		g.drawString("Tower Defense", 110,80);
